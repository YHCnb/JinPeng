    ...
    <view>
        ...
        <uni-forms ref="form">
          <view class="text-box">
            ...
            <uni-easyinput class="easyinput" :style="easyinputStyle" :placeholderStyle="placeholderStyle" maxlength=-1
              type="textarea" v-model="diagDetail.symptomDesc" placeholder="请输入影像描述"></uni-easyinput>
          </view>
        </uni-forms>
        ...
        <view class="button-group">
          <view class="little-button-group">
            ...
            <button @click="imageRecognition" class="little-button1">
              <uni-icons type="camera" size="22" color=#2979FF></uni-icons>图像识别
            </button>
          </view>
            ...
            <view class="diag-info-container">
              <view class="info-item">
                <view class="info-title-container">
                  ...
                  <text class="info-title">报告文本：</text>
                </view>
                <p class="info">{{ diagDetail.symptomDesc }}</p>
              </view>
              <view class="info-item">
                <view class="info-title-container">
                  <image class="info-title-image" mode="aspectFit" src="@/static/images/tabbar/gradient.png" />
      ...
      <uni-popup ref="pop">
        <view class="content">
          ...
          <bt-cropper ref="cropper" :imageSrc="imageSrc" :mask="mask" ratio="0" :initPosition="initPosition"
      ...
      methods: {
        ...
        conImg2Text(result) {
          ...
          sendImg(tempFilePaths[0]).then((res) => {
            ...
            imageToText(url).then((res) => {
              console.log(res)
              this.diagDetail.symptomDesc = res.msg
        ...
        viewDiagnosis() {
          ...
          getXrayFeedback(JSON.stringify(requestData)).then((res) => {
            this.$modal.closeLoading();
            //使报告表单的结果变成大模型输出
